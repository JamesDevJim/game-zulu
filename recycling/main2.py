...
spaceShip = pygame.transform.scale(
    pygame.image.load("Images/inside_space_ship.jpg"), SCREEN_SIZE
)
spaceShipFail = pygame.transform.scale(
    pygame.image.load("Images/inside_space_ship_fail.jpg"), SCREEN_SIZE
)
spaceShipSuccess = pygame.transform.scale(
    pygame.image.load("Images/inside_space_ship_success.jpg"), SCREEN_SIZE
)
...
def success():
    ...
    while True:
        ...
        BUTTON_WIDTH = (
            DISPLAY_WIDTH * 0.25
        )  # Number is a scaling factor. On 1920 screen this is a 300mm button
        BUTTON_HEIGHT = (
            DISPLAY_HEIGHT * 0.17
        )  # Number is a scaling factor. On 1080 screen this is a 150mm button
